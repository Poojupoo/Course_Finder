...
<form runat ="server" >
 <asp:Button ID="Button1" runat="server" Text="Add Course" BorderColor="Black" BackColor="#409FFF" Style="z-index: 112; left: 80%; position: absolute; top: 75%;"
   ...
   <center><table>
        <tr>
            <td colspan="2" style="font-size: 20px; color: #000000">
                <br />
            </td>
        </tr>
        <tr>
            <td style="font-size: 20px; color: #000000; width: 165px;">
                &nbsp;</td>
            <td style="font-size: 20px; color: #000000; width: 820px;">
                &nbsp;</td>
        </tr>
        <tr>
            <td style="font-size: 20px; color: #000000; width: 165px;">
                Select College</td>
            <td style="font-size: 20px; color: #000000; width: 820px;">
    <asp:DropDownList ID="ddlcourse0" runat="server" 
        AutoPostBack="True" Font-Size="Large" 
                   onselectedindexchanged="ddlcourse_SelectedIndexChanged" 
                    DataSourceID="SqlDataSource1" DataTextField="COLLEGE" DataValueField="ID" 
                    Width="300px"  >  <%--Style="z-index: 112; left: 112%; position: absolute; top: 283%; color: #000000; height: 19px;" --%>
        ...
        <asp:ListItem>Diploma</asp:ListItem>
               ...
               <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT [COLLEGE], [ID] FROM [CLG]"></asp:SqlDataSource>--%>
        ...
        <tr>
            <td style="font-size: 20px; color: #000000; width: 300px;">
                Select Course 
            </td>
            <td style="font-size: 20px; color: #000000; width: 820px;">
    <asp:DropDownList ID="ddlcourse" runat="server" 
        AutoPostBack="True" Font-Size="Large" 
                   onselectedindexchanged="ddlcourse_SelectedIndexChanged"  >  <%--Style="z-index: 112; left: 112%; position: absolute; top: 283%; color: #000000; height: 19px;" --%>
        <asp:ListItem Selected="True">Select</asp:ListItem>
        <asp:ListItem>BCA</asp:ListItem>
        <asp:ListItem>B.Com</asp:ListItem>
        <asp:ListItem>B.A</asp:ListItem>
