...
<form id="Form1" runat ="server" >
 <asp:Button ID="Button1" runat="server" Text="Add College Image" BorderColor="Black" BackColor="#409FFF" Style="z-index: 112; left: 80%; position: absolute; top: 75%;" Font-Size="Large" onclick="Button1_Click" />
...
<table>
    ...
    <tr>
        ...
        <td style="font-size: 20px; color: #000000">
            <asp:TextBox ID="lblCollegeId" runat="server" Enabled="False"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td style="font-size: 20px; color: #FFFFFF; width: 165px;">
