...
<%--<div class="wrappers">--%>
    <asp:Label ID="lblsearch" runat="server" 
            Text="SELECT COLLEGE" Font-Names="Algerian" Font-Bold="True" Font-Size="X-Large"></asp:Label>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <br />
    <br />
<%--</div>--%>
<asp:Label ID="Label1" runat="server" 
                 Font-Size="X-Large" Font-Names="Andulus" Font-Bold="True"></asp:Label>
        <%--<span class="style1">
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <span class="style2"> &nbsp;&nbsp;SEARCH COLLEGE&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;
            </span>--%>
<div class ="wrapperss " style="top: 30%; left: 40%">
</div>
<div class ="wrapp ">
    <asp:GridView ID="GridView1" runat="server" ShowHeader ="false" 
        ...
        <Columns >
            <asp:TemplateField >
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" CommandArgument='<% #Bind("ID") %>' runat="server" Text='<% #Bind("COLLEGE") %>' OnClick ="LinkButton1_Click" OnCommand ="LinkButton1_Click" ></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
        onselectedindexchanged="GridView2_SelectedIndexChanged" Width="692px">
    </asp:GridView>

  <%-- NavigateUrl ='<% #Eval("COLLEGE","Default2.aspx?COLLEGE={0}") %>'--%>
